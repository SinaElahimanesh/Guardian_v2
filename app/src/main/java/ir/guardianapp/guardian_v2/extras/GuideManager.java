...
public class GuideManager {
    ...
    public static void showGuide(Activity activity){
        ...
        allGuideViews[1] = activity.findViewById(R.id.alertMessageBox);
        allGuideViews[2] = activity.findViewById(R.id.driving_background);
        allGuideViews[3] = activity.findViewById(R.id.statistic);
        allGuideViews[4] = activity.findViewById(R.id.menuButton);

        allGuideStrings[0] = activity.getString(R.string.showcase_restbutton);
        allGuideStrings[1] = activity.getString(R.string.showcase_alertmessagetext);
        allGuideStrings[2] = activity.getString(R.string.showcase_drivingbackground);
        allGuideStrings[3] = activity.getString(R.string.showcase_statistics);
        allGuideStrings[4] = activity.getString(R.string.showcase_menubutton);
