...
public class SolarEventCalculator {
     ...
     *         date.
     */
    public String computeSunriseTime(SunsetSunrise solarSunsetSunrise, Calendar date) {
        return getLocalTimeAsString(computeSolarEventTime(solarSunsetSunrise, date, true));
    }
     ...
     */
    public Calendar computeSunriseCalendar(SunsetSunrise solarSunsetSunrise, Calendar date) {
        return getLocalTimeAsCalendar(computeSolarEventTime(solarSunsetSunrise, date, true), date);
    }
     ...
     *         date.
     */
    public String computeSunsetTime(SunsetSunrise solarSunsetSunrise, Calendar date) {
        return getLocalTimeAsString(computeSolarEventTime(solarSunsetSunrise, date, false));
    }
     ...
     */
    public Calendar computeSunsetCalendar(SunsetSunrise solarSunsetSunrise, Calendar date) {
        return getLocalTimeAsCalendar(computeSolarEventTime(solarSunsetSunrise, date, false), date);
    }

    private BigDecimal computeSolarEventTime(SunsetSunrise solarSunsetSunrise, Calendar date, boolean isSunrise) {
        ...
        BigDecimal cosineSunLocalHour = getCosineSunLocalHour(sunTrueLong, solarSunsetSunrise);
    ...
    private BigDecimal getCosineSunLocalHour(BigDecimal sunTrueLong, SunsetSunrise sunsetSunrise) {
        ...
        BigDecimal zenithInRads = convertDegreesToRadians(sunsetSunrise.degrees());
